# Original git repository https://github.com/StaymanHou/WordpressDefaultVCLv4
# Author: Stayman Hou
...
backend server1 { # Define one backend
  .host = "123.45.67.89";    # IP or Hostname of backend
...
sub vcl_recv {
  ...
  # Allow purging
  # This works with the Wordpress Varnish HTTP Purge Plugin https://wordpress.org/plugins/varnish-http-purge/
  if (req.method == "PURGE") {
